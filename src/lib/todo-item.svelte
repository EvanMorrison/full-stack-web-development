<script lang="ts">
    ...
    export let processDeletedTodo: (res: Response) => void;
    export let processUpdatedTodo: (res: Response, form: HTMLFormElement) => void;
</script>

<div class="todo" class:done={todo.done}>
    <form action="/todos/{todo.uid}.json?_method=patch" method="post" use:enhance={{
        result: processUpdatedTodo
    }}>
...
<style>
    .todo {
        ...
        transition: filter 0.2s, transofrm 0.2s;
    }
